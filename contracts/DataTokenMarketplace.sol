...
contract DataTokenMarketplace {
    ...
    IERC20 public immutable usdc;       // Sepolia USDC
    address public immutable treasury;  // your platform wallet
    uint256 public constant FEE_BPS = 500; // 5% fee on BUY (USDC side)
    ...
    function buy(address token, uint256 usdcIn, uint256 minTokensOut) external {
        ...
        // split 80% creator / 20% treasury (tune as you like)
    ...
    // price ≈ rUSDC/rToken (scaled 1e18 for readability)
